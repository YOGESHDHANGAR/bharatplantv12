...
import { useCreatePurchase } from "../../../api/mutations/purchaseMutations";
...
const PurchaseEntry = () => {
  ...
  const onSubmit = async (formData) => {
    ...
    await createPurchaseAsync(formData);
...
export default React.memo(PurchaseEntry);
