...
const generateExcel = (data) => {
  ...
  XLSX.utils.book_append_sheet(wb, ws, "Purchases Report"); // Append the sheet
  XLSX.writeFile(wb, "purchases-report.xlsx"); // Write to file
};
  ...
  const handleDownload = async (format) => {
    ...
    switch (format) {
      ...
      case "CSV":
        ...
        link.setAttribute("download", "purchases-report.csv");
